...
class gsp_myFinanceManager_shopedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(shopInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(shopInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(shopInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:shopInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1406189146390L
