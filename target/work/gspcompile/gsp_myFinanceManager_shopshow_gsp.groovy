...
class gsp_myFinanceManager_shopshow_gsp extends GroovyPage {
...
printHtmlPart(13)
if(true && (shopInstance?.shopName)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("shop.shopName.label"),'default':("Shop Name")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(shopInstance),'field':("shopName")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
createTagBody(2, {->
...
invokeTag('link','g',38,['class':("edit"),'action':("edit"),'resource':(shopInstance)],3)
printHtmlPart(19)
...
invokeTag('form','g',41,['url':([resource:shopInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1406189146477L
